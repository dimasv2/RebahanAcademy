...
class cbmi extends StatefulWidget {
  const cbmi({Key? key}) : super(key: key);

  @override
  State<cbmi> createState() => _cbmiState();
}

class _cbmiState extends State<cbmi> {
  _launchurl() async {
...
//   const cbmi({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Source Code Aplikasi BMI'),
      ),
